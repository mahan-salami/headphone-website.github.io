...
import P9 from "../assets/category/smartwatch2-removebg-preview.png"
export default function Popup() {
  return (
    <div className="w-full flex justify-center items-center py-10">
      <div className="bg-green-500 w-[90%] md:h-[250px] md:w-[90%] rounded-2xl flex flex-col md:flex-row items-center justify-between p-6 md:p-10 relative ">
        ...
        <div className="text-white text-center md:text-right md:w-1/3">
          ...
          <button className="mt-4 bg-white text-green-600 px-5 py-2 rounded-full font-medium hover:bg-gray-200 transition">
            Shop
          </button>
        </div>
      </div>
